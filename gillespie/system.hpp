...
public:
    ...
    UnsignedInt /*a temporary variable used to store the product x[]*x[]*/A, /*worrk space */W, /*this is a_0 in gillespie2007stochastic*/Z, /*the right-hand side of Eq. (10b) in gillespie2007stochastic*/RHS, /*the random number used to draw the reaction, equal to r2 in Eq. (10b) in gillespie2007stochastic*/ R;
