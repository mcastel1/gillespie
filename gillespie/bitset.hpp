...
public:
    ...
    void SubstractTo(BitSet*, Bits*), AddTo(BitSet*, Bits*), AddTo(Bits*, Bits*), Multiply(UnsignedInt*, UnsignedInt*), Multiply(UnsignedInt*, unsigned int, unsigned int, UnsignedInt*), AndTo(Bits*, unsigned int, unsigned int), MultiplyKabatsuba(UnsignedInt*, UnsignedInt*);
