...
public:
    ...
    void SubstractTo(BitSet*, Bits*), AddTo(BitSet*, Bits*), AddTo(Bits*, Bits*), AddTo(Bits*, unsigned int, Bits*), Multiply(UnsignedInt*, UnsignedInt*), Multiply(UnsignedInt*, unsigned int, unsigned int, UnsignedInt*), AndTo(Bits*, unsigned int, unsigned int), MultiplyKabatsuba(UnsignedInt*, unsigned int, unsigned int, UnsignedInt*, UnsignedInt*, UnsignedInt*, UnsignedInt*, UnsignedInt*, UnsignedInt*);
