...
public:
    ...
    void SubstractTo(BitSet*, Bits*), AddTo(BitSet*, Bits*), AddTo(Bits*, Bits*), Multiply(UnsignedInt*, UnsignedInt*), DivideByTwoTo(UnsignedInt*), AndTo(Bits*, unsigned int, unsigned int);
